...
$query="select gproducts_sale.*,tbl_gogas_customers.gcustomer_name,tbl_gogas_customers.gcustomer_email,tbl_gogas_customers.gcustomer_number,tbl_gogas_customers.gcustomer_state,tbl_gogas_customers.gcustomer_city,tbl_gogas_customers.gcustomer_pincode,tbl_gogas_customers.gcustomer_landmark,tbl_gogas_customers.gcustomer_id,tbl_gproducts.* from gproducts_sale INNER JOIN tbl_gogas_customers On gproducts_sale.gcustomer_id = tbl_gogas_customers.gcustomer_id INNER JOIN tbl_gproducts On gproducts_sale.product_id = tbl_gproducts.product_id where gproducts_sale.sale_product_id = '".$data['sale_product_id']."'";
